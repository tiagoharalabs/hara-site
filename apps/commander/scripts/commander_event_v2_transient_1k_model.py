...
def main() -> int:
    ...
    if args.check:
        ...
        print("COMMANDER_TRANSIENT_LINUX_HEALTH_P95_SECONDS=0.439385")
        print("COMMANDER_TRANSIENT_LINUX_INVOKE_P95_SECONDS=0.711329")
        print("COMMANDER_TRANSIENT_LINUX_REPLAY_P95_SECONDS=0.541461")
